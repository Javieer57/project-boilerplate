 ...
 * Version: 1.1.2
 */
!function(i){"use strict";i.fn.LineProgressbar=function(n){return n=i.extend({percentage:100,ShowProgressCount:!0,duration:1e3,unit:"%",animation:!0,fillBackgroundColor:"#3498db",backgroundColor:"#EEEEEE",radius:"0px",height:"10px",width:"100%"},n),i.options=n,this.each(function(r,t){void 0===i(t).data("progress-init")&&i(t).data("progress-init",n.percentage),i(t).data("progress-init")===n.percentage&&i(t).html('<div class="progressbar"><div class="proggress"></div><div class="percentCount"></div></div>');var a=i(t).find(".proggress"),o=i(t).find(".progressbar");a.css({backgroundColor:n.fillBackgroundColor,height:n.height,borderRadius:n.radius}),o.css({width:n.width,backgroundColor:n.backgroundColor,borderRadius:n.radius}),n.animation?a.animate({width:n.percentage+"%"},{step:function(r){n.ShowProgressCount&&i(t).find(".percentCount").text(Math.round(r)+n.unit)},duration:n.duration}):(a.css("width",n.percentage+"%"),i(t).find(".percentCount").text(Math.round(n.percentage)+"%"))})}}(jQuery),$("[line-progressbar]").each(function(){var r=$(this);var t=0;r.waypoint(function(){(t+=1)<2&&r.LineProgressbar({percentage:r.data("percentage"),unit:r.data("unit"),animation:r.data("animation"),ShowProgressCount:r.data("showcount"),duration:r.data("duration"),fillBackgroundColor:r.data("progress-color"),backgroundColor:r.data("bg-color"),radius:r.data("radius"),height:r.data("height"),width:r.data("width")})},{offset:"100%",triggerOnce:!0})});